	...
	public void beforeClass(@Optional("chrome") String browsername) {
		if (browsername.equalsIgnoreCase("chrome")) {
			...
			System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\King\\Desktop\\selenium_workspace\\worksace\\seleniumAutomation\\Browserdriver\\chromedriver.exe");
			driver = new ChromeDriver();
		} else if (browsername.equalsIgnoreCase("firefox")) {
			// firefox
			System.setProperty("webdriver.gecko.driver",
					"C:\\Users\\King\\Desktop\\selenium_workspace\\worksace\\seleniumAutomation\\Browserdriver\\geckodriver.exe");
			driver = new FirefoxDriver();
		} else if (browsername.equalsIgnoreCase("Edge")) {
			// edge
			System.setProperty("webdriver.edge.driver",
					"C:\\Users\\King\\Desktop\\selenium_workspace\\worksace\\seleniumAutomation\\Browserdriver\\msedgedriver.exe");
